...
echo "  2. Generate a validator key:  karoowa wallet new --output /opt/karoowa/keys/validator.key"
echo "  3. Start the node:  sudo systemctl enable --now karoowa-node"
echo "  4. Check status:    sudo systemctl status karoowa-node"
echo "  5. View logs:       sudo journalctl -u karoowa-node -f"
